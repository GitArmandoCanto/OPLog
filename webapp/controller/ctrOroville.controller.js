sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast) {
        ...
        return Controller.extend("nmspoplog.oplog.controller.oroville", {
            onInit: async function () {
                var oView = this.getView("oroville");
                var oModel = new sap.ui.model.json.JSONModel();
                var dataModelInitial;
                var dataModel = this.getOwnerComponent().getModel("dataOr");
                ...
                if (dataModel.oData.init !== "X") {         //This will only execute the first time the view is displayed
                    ...
                    oRouter.getRoute("RouteOr").attachMatched(this._onRouteMatched, this);
                }


                //var lbl_exp = this.getView("oroville").byId("lbl_exp_date0").setVisible=("false");


                //Se puede obtener el objeto que necesitamos modificar por medio del id del mismo objeto
                //this.getView("oroville").byId("lbl_hddate").setText(dataModel.oData.valDate);
                ...
                var object;
                //object = this.getView("oroville").byId("ipt_CliftCourt6_elevation");
            ...
            getRmrksSrv: async function (UsrModel, data, dataModelMain) {
                ...
                const oPromise = await new Promise(function (resolve, reject) {
                    ...
                    UsrModel.read("/Oroville", {
                        urlParameters: {
                            "Orovilledate": dataModelMain.oData.valParamDate
                            //"$top" : 1
                        },
                        success: (oData) => {
                            //alert(oData.results[0].Accm);
            ...
            OnCbxChng: function (evt) {
                var view = this.getView("oroville");
            ...
            onClear: function (evt) {
                ...
                this.getView("oroville").byId(objid).setValue("");
            },


            SetData: function (userData, wcdData, plantData, rmrksData, MidCondData, date, model,opLogData) {
                var oDateFormat1 = sap.ui.core.format.DateFormat.getDateInstance({
                    pattern: "M/d/yy"
                });
                ...
                dataModel.setProperty("/val_log_table",opLogData)
            ...
            OnLiveChgEvt: function (evt) {
                ...
                //Se obtiene la vista, lo cual nos da acceso a todos los componentes en ella.
                var vistaOnChange = this.getView("oroville");
                ...
                MessageBox.confirm("Are you ready to submit?", {
                    ...
                    onClose: async function (sAction) {
                        if (sAction === "OK") {
                            ...
                            var oView = this.that.getView("oroville");
                            ...
                            if (MidNgthConSrv[0].result === "ERROR") {
                                ...
                                if (remarksSrv[0].result === "ERROR") {
                                    ...
                                    var dataModel = this.that.getOwnerComponent().getModel("dataOr");
            ...
            _onRouteMatched: function (oEvent) {
                ...
                dataModelOr.oData.init = "X";
                //dataModelInitial = this.getOwnerComponent().getModel("dataOr");
                if (dataModelOr.oData.initidx !== "") {
                    dataModelOr.oData.initidx = "X"
                    this.onInit();
