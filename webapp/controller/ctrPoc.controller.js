sap.ui.define([
    ...
    function (Controller, MessageBox) {
        ...
        return Controller.extend("nmspoplog.oplog.controller.poc", {
            onInit: async function () {
                sap.ui.core.BusyIndicator.show();
                var oView = this.getView("poc");
                var oModel = new sap.ui.model.json.JSONModel();
                var dataModel = this.getOwnerComponent().getModel("dataPoc");
                ...
                if (dataModel.oData.init !== "X") {         //This will only execute the first time the view is displayed
                    ...
                    oRouter.getRoute("RoutePoc").attachMatched(this._onRouteMatched, this);
                }



                //var lbl_exp = this.getView("poc").byId("lbl_exp_date0").setVisible=("false");


                //Se puede obtener el objeto que necesitamos modificar por medio del id del mismo objeto
                //this.getView("poc").byId("lbl_hddate").setText(dataModel.oData.valDate);
                                                                                    ...
                                                                                    if (WcdSrvReid[0].result === "ERROR") {
                                                                                        ...
                                                                                        if (MidNgthConSrv[0].data.results.length === 0) {
                                                                                            ...
                                                                                            dataModel = this.SetData(usrSrv, WcdSrv, PusRepSrv, rmrksSrv, MidNgthConSrv, McDate, dataModel, WcdSrvDT, PusRepSrvDT, WcdSrvSL, PusRepSrvSL
                                                                                                , WcdSrvSJ, PusRepSrvSJ, WcdSrvSou, PusRepSrvSou, WcdSrvPine, PusRepSrvPine, WcdSrvReid, PusRepSrvReid, formResult);
                                                                                            //oModel.setData(null);
                                                                                            oModel = dataModel;
                                                                                            oView.setModel(oModel);
                                                                                        }
                ...
                var object;
                //object = this.getView("poc").byId("ipt_CliftCourt6_elevation");
            ...
            getRmrksSrv: async function (UsrModel, data, dataModelMain) {
                ...
                const oPromise = await new Promise(function (resolve, reject) {
                    UsrModel.read("/Poc", {
                        urlParameters: {
                            "Pocdate": dataModelMain.oData.valParamDate
                            //"$top" : 1
                        },
                        success: (oData) => {
                            //alert(oData.results[0].Accm);
            ...
            SetData: function (userData, wcdData, plantData, rmrksData, MidCondData, date, model, WcdSrvDT, PusRepSrvDT, WcdSrvSL, PusRepSrvSL, WcdSrvSJ, PusRepSrvSJ, WcdSrvSou, PusRepSrvSou
                , WcdSrvPine, PusRepSrvPine, WcdSrvReid, PusRepSrvReid, formResult) {
                ...
                //var dayOfWeek = new Date(MidCondData[0].data.results[0].Mcdate);
                ...
                dataModel.setProperty("/valDateFormatted", logDate);
                ...
                switch (MidCondData[0].data.results[0].Natsec) {
                    ...
                    case "GREEN":
                        dataModel.setProperty("/val_lstStlNat", "keyStlNat4");
                        iconSec.setBackgroundColor("");
                        iconSec.setColor("");

                    case "BLUE":
                        dataModel.setProperty("/val_lstStlNat", "keyStlNat5");
                        iconSec.setBackgroundColor("");
                        iconSec.setColor("");

                    case "YELLOW":
                        dataModel.setProperty("/val_lstStlNat", "keyStlNat6");
                        iconSec.setBackgroundColor("");
                        iconSec.setColor("");

                    case "ORANGE":
                        dataModel.setProperty("/val_lstStlNat", "keyStlNat7");
                        iconSec.setBackgroundColor("");
                        iconSec.setColor("");

                    case "RED":
                        dataModel.setProperty("/val_lstStlNat", "keyStlNat8");
                        iconSec.setBackgroundColor("");
                        iconSec.setColor("");
                        break;
                    default:
                ...
                switch (MidCondData[0].data.results[0].Dwrsec) {
                    ...
                    case "IMMINENT":
                        ...
                        break;
                    case "1":
                        dataModel.setProperty("/val_lstStlDwr", "keyStlDwr4");
                        iconDWR.setBackgroundColor("");
                        iconDWR.setColor("");
                        ...
                        break;
                    case "2":
                        dataModel.setProperty("/val_lstStlDwr", "keyStlDwr5");
                        iconDWR.setBackgroundColor("");
                        iconDWR.setColor("");
                        ...
                        break;
                    case "3":
                        dataModel.setProperty("/val_lstStlDwr", "keyStlDwr6");
                        iconDWR.setBackgroundColor("");
                        iconDWR.setColor("");
                        ...
                        break;
                    case "4":
                        dataModel.setProperty("/val_lstStlDwr", "keyStlDwr7");
                        iconDWR.setBackgroundColor("");
                        iconDWR.setColor("");
            ...
            onClear: function (evt) {
                ...
                this.getView("poc").byId(objid).setValue("");
            },
                ...
                MessageBox.confirm("Are you ready to submit?", {
                    ...
                    onClose: async function (sAction) {
                        if (sAction === "OK") {
                            ...
                            var oView = this.that.getView("poc");
                            ...
                            if (MidNgthConSrv[0].result === "ERROR") {
                                ...
                                if (remarksSrv[0].result === "ERROR") {
                                    ...
                                    var dataModel = this.that.getOwnerComponent().getModel("dataPoc");
            ...
            _onRouteMatched: function (oEvent) {
                ...
                var dataModelPoc = this.getOwnerComponent().getModel("dataPoc");//Will contain data mapped from the ODATA services
                dataModelPoc.oData.init = "X";
                //dataModelInitial = this.getOwnerComponent().getModel("dataPocOr");
                if (dataModelPoc.oData.initidx !== "") {
                    dataModelPoc.oData.initidx = "X"
                    this.onInit();
