sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast) {
        ...
        return Controller.extend("nmspoplog.oplog.controller.ctrSanJ", {
            onInit: async function () {
                this.attachAfterShow(this.onAfterShow);

                var oView = this.getView("sanJ");              //Instance of view
                var oModel = new sap.ui.model.json.JSONModel(); //This model  will contain the data
                var dataModel = this.getOwnerComponent().getModel("dataSj");//Will contain data mapped from the ODATA services
                ...
                if (dataModel.oData.init !== "X") {         //This will only execute the first time the view is displayed
                    ...
                    oRouter.getRoute("RouteSj").attachMatched(this._onRouteMatched, this);
                }
...
//#endregion onFocusOut
            ...
            getRmrksSrv: async function (UsrModel, data, dataModelMain) {
                ...
                var reject = "";
                const oPromise = await new Promise(function (resolve, reject) {
                    UsrModel.read("/Sanjoaquin", {
                         urlParameters: {
                        "SanJoaquindate": dataModelMain.oData.valParamDate
                        //"$top" : 1
                        },
                        // urlParameters: {
                        //"Divis": "'WRSJ'"
            ...
            OnLiveChgEvt: function (evt) {
                ...
                var vistaOnChange = this.getView("sanJ");
                ...
                MessageBox.confirm("Are you ready to submit?", {
                    ...
                    onClose: async function (sAction) {
                        if (sAction === "OK") {
                            ...
                            var oView = this.that.getView("sanJ");
                            ...
                            if (MidNgthConSrv[0].result === "ERROR") {
                                ...
                                if (remarksSrv[0].result === "ERROR") {
                                    ...
                                    //MessageBox.success("Data submitted successfully")
                                     var dataModel = this.that.getOwnerComponent().getModel("dataSj");
            ...
            _onRouteMatched: function (oEvent) {
                ...
                var dataModelSj = this.getOwnerComponent().getModel("dataSj");//Will contain data mapped from the ODATA services
                dataModelSj.oData.init = "X";
                //dataModelInitial = this.getOwnerComponent().getModel("dataOr");
                if (dataModelSj.oData.initidx !== "") {
                    dataModelSj.oData.initidx = "X"
                    this.onInit();
