		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Operating Log",
									"targetURL": "#nmspoplogoplog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmspoplogoplog-display": {
								"semanticObject": "nmspoplogoplog",
								"action": "display",
								"description": "Operating Log",
								"title": "Operating Log",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nmspoplog.oplog",
									"url": sap.ui.require.toUrl("nmspoplog/oplog")
								}
							}
						}
					}
